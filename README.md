...
There are a ton of different Coordinate systems, from cartesian, to polar, to spherical, and even some weird, higher-dimensional ones.
...
### Creating a planet with modified geometry and/or tunnels

To create a planet whose body you can modify, you need to replace the body of the planet generated by New Horizons with your own custom shell model. The way I'd recommend you to do this, is to create a UV Sphere in Blender, and press F9 to modify its parameters. Once there, change the radius to whatever your planet's radius is, and increase the sectioning/banding to increase the sphere's resolution.

Once you export this model, change the Ground Size parameter of your planet file to 1 so that the gravity still acts as if it's a large planet, but in reality it's just a tiny little ball.
